...
df_hospital_addresses = pd.read_csv('https://github.com/kkettip/datasci_7_geospatial/blob/main/Datasets/assignment7_slim_hospital_addresses.csv')
hospital_addresses_sample = df_hospital_addresses.sample(100)
hospital_addresses_sample

df_hospital_coordinates = pd.read_csv('https://raw.githubusercontent.com/kkettip/datasci_7_geospatial/main/Datasets/assignment7_slim_hospital_coordinates.csv')
